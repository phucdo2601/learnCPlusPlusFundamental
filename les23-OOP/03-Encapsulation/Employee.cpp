...
class Employee {
    ...
    private: bool isMariage;
    private: char specSign;
    private: list<string> listDepts;
...
int main() {
    ...
    /**
     * if variable in class set public, then we can call and declare them in any where
    */
    // Employee emp1;
    // emp1.Name = "Phucdn";
